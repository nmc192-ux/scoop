...
export const TOPICS = [
  ...
  { id: "country-focus",        label: "Pakistan",               emoji: "🇵🇰", color: "#01411C" },
  { id: "business-finance",     label: "Business & Finance",     emoji: "💼", color: "#F59E0B" },
  { id: "entertainment-sports", label: "Entertainment & Sports", emoji: "🎬", color: "#34C759" },
  { id: "health-fitness",       label: "Health & Fitness",       emoji: "💪", color: "#4CD964" },
  { id: "ai",                   label: "AI",                     emoji: "🤖", color: "#007AFF" },
  { id: "science-technology",   label: "Science & Technology",   emoji: "🔬", color: "#0EA5E9" },
];

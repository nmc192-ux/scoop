...
export default function VideoModal({ video, onClose }) {
  ...
  // Error codes 101 and 150 mean "embedding disabled by owner."
  useEffect(() => {
    if (!video) return;
    const onMessage = (e) => {
  ...
  const embedUrl = `https://www.youtube.com/embed/${video.video_id}?autoplay=1&rel=0&modestbranding=1&enablejsapi=1`;

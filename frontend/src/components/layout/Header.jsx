      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-14 sm:h-16">
          ...
          <div className="flex items-center gap-1 sm:gap-1.5">
            ...
            {/* Country focus selector for "Pakistan" tab */}
            <select
              value={countryFocus}
              onChange={(e) => setCountryFocus(e.target.value)}
              className="hidden md:block rounded-full border border-[var(--color-border)] bg-[var(--color-surface2)] px-3 py-1 text-xs font-semibold text-[var(--color-text-secondary)] outline-none hover:text-[var(--color-text)]"
              title="Country focus for Pakistan tab"
            >

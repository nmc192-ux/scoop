...
export default function App() {
  const { activeTopics, searchQuery, lastRefreshed, language, countryFocus } = useNewsStore();
  ...
  const topicLabels = {
    top: "Top Stories",
    world: "World",
    "country-focus": countryFocus === "pakistan"
      ? "Pakistan"
      : countryFocus === "usa"
      ? "USA"
      : countryFocus === "uk"
            ...
            <div className="flex items-center justify-between mb-4">
              <h2 className={isUrdu
                ...
                {searchQuery
                  ...
                  : activeTopics.map(t => topicLabels[t] || t).join(" · ")}
              </h2>
              {articles.length > 0 && (
